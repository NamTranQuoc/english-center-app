...
class _ForgetPassword extends State<ForgetPassword> {
  ...
  onSubmit() {
    if (formGlobalKey.currentState!.validate()) {
      ...
      forgetPassword(newPassword.text, confirmPassword.text, code.text, widget.email).then((value) {
        if (value.code == 9999) {
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    InputPassword(AppLocalizations.of(context).newPassword, newPassword),
                    InputPassword(AppLocalizations.of(context).confirmPassword, confirmPassword),
                  ],
                ),
              ),
              Container(
